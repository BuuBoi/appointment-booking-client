      ...
      <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
        <div className="relative max-w-xl mx-auto sm:text-center">
          <h3 className="text-gray-800 text-3xl font-semibold sm:text-4xl">
            Service prices for all packages
          </h3>
          <div className="mt-3 max-w-xl">
            <p>
              Become part of the leading family doctor team. Provide dedicated
              and professional medical services right at the patient's home at a
              reasonable cost. Contact us for more details and choose the most
              suitable package.
            </p>
          </div>
        </div>
